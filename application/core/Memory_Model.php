...
//---------------------------------------------------------------------------
    ...
    public function exists($key, $key2 = null)
    {
...
//---------------------------------------------------------------------------
    ...
    public function trailing($count = 10)
    {
     ...
     * @return type
     */
    public function some($what, $which)
    {
        $results = array();
    ...
    public function head($count = 10)
    {
        return array_slice($this->_data, 0, $count);
    }

    // Retrieve records from the end of a table.
    public function tail($count = 10)
    {
        return array_slice($this->_data, 0 - $count);
    }
